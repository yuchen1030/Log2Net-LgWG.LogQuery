...
using LgWG.LogQuery.Sessions;
using LgWG.LogQuery.Users.Dto;
using LgWG.LogQuery.Web.Controllers.Results;
using LgWG.LogQuery.Web.Models;
using LgWG.LogQuery.Web.Models.Account;
using Log2Net;
...
{
    public class AccountController : LogQueryControllerBase
    {
        ...
        public AccountController(
            ...
            IAuthenticationManager authenticationManager, ICacheManager cacheManager)
        {
        ...
        string GetUserSysCategoryAccordingRoleID()
        {
            var allUsersSysCategory = _cacheManager.GetCache("LgWG.LogQuery").Get("UserSysCategorys", null) as List<UserSysCategorys>;
            var sysCateIDs = allUsersSysCategory.Where(a => AbpSession.UserId != null && (long)a.UserID == (long)AbpSession.UserId).FirstOrDefault().SysCateIDs;
            return sysCateIDs;
        }
        ...
        public async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "")
        {
          ...
          //  var sysIDs = GetUserSysCategoryAccordingRoleID();

          //  loginResult.Identity.AddClaim(new Claim("UserSysCategorys", sysIDs));
